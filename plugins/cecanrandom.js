...
let handler = async (m, { conn }) => {
    ...
    if (!img) throw img
    await conn.sendFile(m.chat, img, '', '© Jangan Insecure!dan jgn bermimpi untuk memilikinya, paras yg indah tdk mnjamin kesetiaannya', m, 0, { thumbnail: await (await fetch(img)).buffer() })
}
