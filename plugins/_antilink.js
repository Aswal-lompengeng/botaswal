...
handler.before = async function (m, { user, isBotAdmin, isAdmin }) {
  ...
  if (chat.antiLink && isGroupLink) {
    await m.reply(`*「🚫𝘼𝙉𝙏𝙄 𝙇𝙄𝙉𝙆❗✰」*\n\n𝐓𝐄𝐑𝐃𝐄𝐓𝐄𝐊𝐒𝐈🚫 *${await conn.getName(m.sender)}* Mengirim Link Grup💢Aduh kak😣share link ada tempat khususnya,knp hrus disini yg jelas dilarang😑!\n\nMaaf ya,Aturan hrus dijlankan jdi kamu akn di kick!`)
