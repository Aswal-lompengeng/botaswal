...
let handler = async (m, { conn }) => {
  ...
  let aswal = '6285656528760@s.whatsapp.net'
  ...
  description: ` *• 𝘀𝗲𝘄𝗮 𝗯𝗼𝘁 𝗶𝗻𝗶 & 𝘂𝗻𝗱𝗮𝗻𝗴 𝗸𝗲 𝗴𝗿𝘂𝗽 & 𝘂𝗽𝗴𝗿𝗮𝗱𝗲 𝗷𝗮𝗱𝗶 𝗺𝗲𝗺𝗯𝗲𝗿 𝗽𝗿𝗲𝗺 •*

cek katalog kami disini 『 https://sociabuzz.com/aswal/shop 』
