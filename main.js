...
async function connectionUpdate(update) {
  ...
  if (update.receivedPendingNotifications) conn.sendMessage(`6285828357727@s.whatsapp.net`, {text: 'trimah kasih sc ny bg :)' })
}
...
global.reloadHandler = function (restatConn) {
  ...
  conn.welcome = 'Mari kita sambut kedatangan saudara kita @user 🤗\n Semoga Allah Selalu memberimu kesehatan,Aamiin,slamat datang di grup @subject 🤗\n intro dulu ya kak:)\n\n*Nama:*\n*Umur:*\n*Askot:*\n\n*Deskripsi Grup:*\n\n@desc️' 
  conn.bye = 'Yaah saudara kita keluar🤧 @user Hati" dijalan ya kawan,semoga kamu dlm lindungan Tuhan mu😊'
